...
<body>
<div class="shell">
  <aside class="side"><div class="brand">Fin<b>RedOps</b></div><div class="version">CONTROL PLANE · v0.1</div><div class="nav"><span class="active">Operations</span><span>Engagements</span><span>Approvals</span><span>Evidence</span><span>Audit chain</span></div><div class="boundary">● SIMULATION-ONLY RUNNER<br>No network or shell capability</div></aside>
  <main class="main">
    <header class="top"><div><div class="eyebrow">Governed security validation</div><h1>__NAME__</h1><div class="sub">__ENGAGEMENT_ID__ · digest __DIGEST__</div></div><div class="status">● __STATUS__</div></header>
    ...
    <section class="grid lower"><article class="panel"><div class="panel-head"><h2>Tamper-evident audit trail</h2><span>SHA-256 hash chain · __EVENTS__ events</span></div><ol class="timeline">__EVENT_ROWS__</ol></article><article class="panel"><div class="panel-head"><h2>Governance alignment</h2><span>Design mapping, not certification</span></div><div class="controls"><div class="control"><b>DORA / TLPT</b><span>Scope, control team, evidence</span></div><div class="control"><b>TIBER-EU</b><span>White-team separation</span></div><div class="control"><b>NIST 800-115</b><span>Planning and reporting</span></div><div class="control"><b>NIST AI RMF</b><span>Governed AI boundary</span></div></div></article></section>
    <p class="foot">Synthetic demonstration only · no production targets, findings, or compliance claims</p>
  </main>
</div>
</body></html>"""
    replacements = {
