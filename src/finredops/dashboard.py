...
<body>
<div class="shell">
  <aside class="side"><div class="brand">Fin<b>RedOps</b></div><div class="version">ASSURANCE CONTROL PLANE · v0.2</div><div class="nav"><span class="active">Operations</span><span>Engagements</span><span>Approvals</span><span>Evidence</span><span>Regulatory reports</span><span>Audit chain</span></div><div class="boundary">● SIMULATION-ONLY RUNNER<br>No network or shell capability</div></aside>
  <main class="main">
    ...
    <section class="assurance-strip"><div><span>Institution profile</span><b>__POLICY_PROFILE__</b></div><div><span>Regulatory profile</span><b>__REG_PROFILE__</b></div><div><span>Crosswalk controls</span><b>__REG_CONTROLS__ VERSIONED</b></div><div><span>Evidence guard</span><b>__REDACTIONS__ REDACTIONS</b></div></section>
    ...
    <section class="grid lower"><article class="panel"><div class="panel-head"><h2>Tamper-evident audit trail</h2><span>SHA-256 hash chain · __EVENTS__ events</span></div><ol class="timeline">__EVENT_ROWS__</ol></article><article class="panel"><div class="panel-head"><h2>Türkiye regulatory assurance</h2><span>Source-linked mapping, not certification</span></div><div class="controls"><div class="control"><b>BDDK · __BDDK__</b><span>BSEBY + 2012/1 scope</span></div><div class="control"><b>SPK · __SPK__</b><span>Current VII-128.10</span></div><div class="control"><b>KVKK · __KVKK__</b><span>Article 12 + security guide</span></div><div class="control"><b>ISO/IEC · __ISO__</b><span>27001:2022 mapped objectives</span></div></div></article></section>
    <p class="foot">Synthetic audit-support demonstration · legal/compliance sign-off and licensed ISO text remain mandatory</p>
  </main>
</div>
</body></html>"""
    replacements = {
